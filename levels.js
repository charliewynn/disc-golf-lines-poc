function loadLevel(lv)
{
  ...
  particles = [];
	...
	scaleX = Math.min(width/(maxX-minX+200), height/(maxY-minY+200))/2;
...
levels[0] =
[new Player(new Vector(-305, 74.25), new Vector(78, 35), 5, 20),
 new Planet(new Vector(-56, -234.5), 900, 80, false, false),
 new Planet(new Vector(290, 65.75), 5, 25, true, false),
 new Planet(new Vector(46, 213), 10, 5, false, true),
 new Planet(new Vector(-31, 213), 10, 5, false, true),
 new Planet(new Vector(117, 201), 10, 5, false, true),
 new Planet(new Vector(185, 172), 10, 5, false, true),
 new Planet(new Vector(246, 136), 10, 5, false, true),
 new Planet(new Vector(-109, 194), 10, 5, false, true),
 new Planet(new Vector(-184, 166), 10, 5, false, true),
 new Planet(new Vector(-254, 120), 10, 5, false, true)];
...
[new Player(new Vector(300, 300), new Vector(-67, -6), 5, 20),
 ...
 levels[4] = 
 [new Player(new Vector(-11.272623387318902, 131.65897976546717), new Vector(-50, -50), 5, 20),
